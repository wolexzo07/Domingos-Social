...
$sqlcmdcount = "withdrawal_transactions WHERE owner_id='$userid'";
$sqlcmd = "SELECT * FROM withdrawal_transactions WHERE owner_id='$userid' ORDER BY id DESC LIMIT $offset, $no_of_records_per_page";
