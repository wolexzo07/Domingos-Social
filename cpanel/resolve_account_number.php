...
$bankname = xg("bankname");$acctno = xg("account_number");
...
$curl = curl_init();
			curl_setopt_array($curl, array(
			  ...
			  CURLOPT_HTTPHEADER => [
				"authorization: Bearer $secretkey", //replace this with your own test key
...
if ($err) {
  ...
  echo "<div class='alert alert-success'><i class='fa fa-check-circle'></i> $account_name ($account_number)</div>";
	...
	?>
  <div class="alert alert-warning"><i class="fa fa-minus-circle"></i> Parameter Missing</div>
  <?php
}
