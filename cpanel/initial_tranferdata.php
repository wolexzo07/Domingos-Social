...
$sqlcmdcount = "transfer_transactions WHERE sender_id='$userid' LIMIT 10";
$sqlcmd = "SELECT * FROM transfer_transactions WHERE sender_id='$userid' ORDER BY id DESC LIMIT 10";
