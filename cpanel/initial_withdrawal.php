...
$sqlcmdcount = "withdrawal_transactions WHERE owner_id='$userid' LIMIT 10";
$sqlcmd = "SELECT * FROM withdrawal_transactions WHERE owner_id='$userid' ORDER BY id DESC LIMIT 10";
...
if($read = x_querycmd($sqlcmd)){
			...
			if($count > 0){
				...
				foreach(x_fetchQuery($sqlcmd) as $Key){
						...
						$amount = $Key["amount"];
						$trx = $Key["withdrawal_id"];
						$date = $Key["time_stamp"];
						$datelocal = $Key["realtime"];
						$rid = $Key["owner_id"];
						
						$bankname = $Key["bankname"];
						$acnum = $Key["account_numb"];
              ...
              <div class="panel panel-primary">
                  ...
                  <div class="panel-body">
                    <p style="display:none;" class="pull-right"><i class="fa fa-bank"></i>  <?php //echo $partner;?></p>
                      ...
                      <p style="letter-spacing:2px;color:black;" class="writer  ft-15">Withdrawal was successful <br/><b><?php echo $bankname." ($acnum)";?></b></p>
              ...
              <div class="panel panel-warning" style="background-color:white">
                  ...
                  <div class="panel-body">
                      ...
                      <h4 style="font-size:15pt;"><i class="fa fa-money" style="color:black;margin-top:;margin-bottom:;"></i> <font style="color:black;"><?php echo $currency." ".number_format($amount,2);?></font> </h4>
                       <p style="letter-spacing:2px;color:green;" class="writer  ft-15">Withdrawal Pending <br/><b><?php echo $bankname." ($acnum)";?></b></p>
                        <p class="pull-right"><i class="fa fa-calendar"></i> &nbsp;<?php echo $datelocal;?></p>
                  </div>
              ...
              <?php
				...
				?>
				<div class="alert text-center"><i class="fa fa-bank msgloading"></i><br/><br/> No transfer was made!</div>
				<?php
			}
	}else{
